...
class ToDo: NSObject, NSCoding {
    ...
    static func loadSampleToDos() -> [ToDo] {
        let todo1 = ToDo(title: "Sample to do (One)", isComplete: false, dueDate: Date(), notes: "Notes 1")
        let todo2 = ToDo(title: "Sample to do (Two)", isComplete: false, dueDate: Date(), notes: "Notes 2")
        let todo3 = ToDo(title: "Sample to do (Three)", isComplete: false, dueDate: Date(), notes: "Notes 3")
